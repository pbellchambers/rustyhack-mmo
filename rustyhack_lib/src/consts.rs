...
pub const DEFAULT_PLAYER_POSITION_X: usize = 16;
pub const DEFAULT_PLAYER_POSITION_Y: usize = 6;
...
pub const DEFAULT_MONSTER_POSITION_X: usize = 20;
pub const DEFAULT_MONSTER_POSITION_Y: usize = 20;
